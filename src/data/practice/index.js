const practice = [
  ...
  },
  {
    id: 'p723',
    type: 'vocabulary',
    question: 'What does "La valigia" mean in English?',
    answer: 'Suitcase',
    hint: 'You pack it before travelling',
  },
  {
    id: 'p724',
    type: 'vocabulary',
    question: 'What does "Il gelato" mean in English?',
    answer: 'Ice cream',
    hint: 'Italian for a frozen treat',
  },
  {
    id: 'p725',
    type: 'vocabulary',
    question: 'What does "La paura" mean in English?',
    answer: 'Fear',
    hint: 'The opposite of courage',
  },
  {
    id: 'p726',
    type: 'vocabulary',
    question: 'What does "La montagna" mean in English?',
    answer: 'Mountain',
    hint: 'Climb to its top with skis or ropes',
  },
  {
    id: 'p727',
    type: 'vocabulary',
    question: 'What does "Stanco" mean in English?',
    answer: 'Tired',
    hint: 'How you feel after a long day',
  },
  {
    id: 'p728',
    type: 'vocabulary',
    question: 'What does "Spesso" mean in English?',
    answer: 'Often',
    hint: 'How frequently something happens',
  },
  {
    id: 'p729',
    type: 'vocabulary',
    question: 'What does "La sorpresa" mean in English?',
    answer: 'Surprise',
  ...
  },
  {
    id: 'p730',
    type: 'vocabulary',
    question: 'What does "La chiave" mean in English?',
    answer: 'Key',
    hint: 'It opens your front door',
  },
  {
    id: 'p731',
    type: 'vocabulary',
    question: 'What does "Il collega" mean in English?',
    answer: 'Colleague',
    hint: 'Someone who works with you',
  },
  {
    id: 'p732',
    type: 'vocabulary',
    question: 'What does "L\'università" mean in English?',
    answer: 'University',
    hint: 'Where students get a degree',
  },
  {
    id: 'p733',
    type: 'vocabulary',
    question: 'What does "Camminare" mean in English?',
    answer: 'To walk',
    hint: 'Moving on foot',
  },
  {
    id: 'p734',
    type: 'vocabulary',
    question: 'What does "La pioggia" mean in English?',
    answer: 'Rain',
    hint: 'You need an umbrella for this weather',
  },
  {
    id: 'p735',
    type: 'multiple_choice',
    question: 'How do you say "Suitcase" in Italian?',
    options: ['La valigia', 'Lo zaino', 'La borsa', 'Il portafoglio'],
    answer: 'La valigia',
    hint: 'Big case for a trip',
  },
  {
    id: 'p736',
    type: 'multiple_choice',
    question: 'How do you say "Backpack" in Italian?',
    options: ['Lo zaino', 'La valigia', 'Il cappotto', 'L\'ombrello'],
    answer: 'Lo zaino',
    hint: 'Carried on your back',
  },
  {
    id: 'p737',
    type: 'multiple_choice',
    question: 'Which word means "aunt" in Italian?',
    options: ['La zia', 'La sorella', 'La figlia', 'La madre'],
    answer: 'La zia',
    hint: 'Sister of your parent',
  },
  {
    id: 'p738',
    type: 'multiple_choice',
    question: 'Which word means "square" in Italian?',
    options: ['La piazza', 'La strada', 'Il ponte', 'La piscina'],
    answer: 'La piazza',
    hint: 'An open space in a town, often with a café',
  },
  {
    id: 'p739',
    type: 'multiple_choice',
    question: 'How do you say "Beach" in Italian?',
    options: ['La spiaggia', 'La collina', 'Il lago', 'La foresta'],
    answer: 'La spiaggia',
    hint: 'Sand and sea',
  },
  {
    id: 'p740',
    type: 'multiple_choice',
    question: 'What is "La pasticceria"?',
    options: ['A pastry shop', 'A bakery', 'A butcher\'s', 'A flower shop'],
    answer: 'A pastry shop',
    hint: 'Where you buy cakes and sweets',
  },
  {
    id: 'p741',
    type: 'multiple_choice',
    question: 'What does "Ordinare" mean?',
    options: ['To order', 'To pay', 'To cook', 'To eat'],
    answer: 'To order',
    hint: 'You do this in a restaurant',
  },
  {
    id: 'p742',
    type: 'multiple_choice',
    question: 'What is "La trattoria"?',
    options: ['A family-run restaurant', 'A hotel', 'A museum', 'A market'],
    answer: 'A family-run restaurant',
    hint: 'A typical, casual Italian restaurant',
  },
  {
    id: 'p743',
    type: 'multiple_choice',
    question: 'Which word means "rain" in Italian?',
    options: ['La pioggia', 'La neve', 'Il vento', 'Il temporale'],
    answer: 'La pioggia',
  ...
  },
  {
    id: 'p744',
    type: 'multiple_choice',
    question: 'How do you say "Tomorrow" in Italian?',
    options: ['Domani', 'Ieri', 'Oggi', 'Presto'],
    answer: 'Domani',
  ...
  },
  {
    id: 'p745',
    type: 'multiple_choice',
    question: 'What does "Il compleanno" mean?',
    options: ['Birthday', 'Anniversary', 'Party', 'Wedding'],
    answer: 'Birthday',
    hint: 'The day of your birth, with a cake and candles',
  },
  {
    id: 'p746',
    type: 'multiple_choice',
    question: 'What is "La poltrona"?',
    options: ['An armchair', 'A table', 'A lamp', 'A mirror'],
    answer: 'An armchair',
    hint: 'A comfortable chair for one person',
  },
  {
    id: 'p747',
    type: 'translation',
    question: 'Translate to Italian: "I take a look at the shopping list."',
    answer: 'Dò uno sguardo alla lista della spesa.',
    hint: 'include the verb "guardare" or "sguardo" and "la spesa"',
  },
  {
    id: 'p748',
    type: 'translation',
    question: 'Translate to Italian: "In the afternoon I walk along the seafront."',
    answer: 'Nel pomeriggio cammino sul lungomare.',
    hint: 'pomeriggio (afternoon), camminare (walk), lungomare (seafront)',
  },
  {
    id: 'p749',
    type: 'translation',
    question: 'Translate to Italian: "The beach umbrella is on the beach."',
    answer: 'L\'ombrellone è sulla spiaggia.',
    hint: 'ombrellone (beach umbrella), spiaggia (beach)',
  },
  {
    id: 'p750',
    type: 'translation',
    question: 'Translate to Italian: "Grandpa sleeps in the armchair."',
    answer: 'Il nonno dorme in poltrona.',
    hint: 'nonno (grandpa), dormire (to sleep), poltrona (armchair)',
  },
  {
    id: 'p751',
    type: 'translation',
    question: 'Translate to Italian: "I have to decide what to study."',
    answer: 'Devo decidere cosa studiare.',
    hint: 'devo (I must), decidere (to decide), studiare (to study)',
  },
  {
    id: 'p752',
    type: 'translation',
    question: 'Translate to Italian: "We organise a party for Mario."',
    answer: 'Organizziamo una festa per Mario.',
    hint: 'organizzare (to organise), festa (party), per (for)',
  },
  {
    id: 'p753',
    type: 'sentence_order',
    question: 'Arrange to form: "Tomorrow I go on holiday"',
    options: ['domani', 'vado', 'vacanza', 'in', 'Io', '.'],
    answer: 'Domani vado in vacanza.',
    hint: 'Start with "Domani"',
  },
  {
    id: 'p754',
    type: 'sentence_order',
    question: 'Arrange to form: "My aunt lives in Milan"',
    options: ['zia', 'Milano', 'a', 'Mia', 'abita', '.'],
    answer: 'Mia zia abita a Milano.',
    hint: 'Start with "Mia zia"',
  },
  {
    id: 'p755',
    type: 'sentence_order',
    question: 'Arrange to form: "After dinner we get an ice cream"',
    options: ['dopo', 'cena', 'un', 'gelato', 'prendiamo', 'la', '.'],
    answer: 'Dopo cena prendiamo un gelato.',
    hint: 'Start with "Dopo cena"',
  },
  {
    id: 'p756',
    type: 'sentence_order',
    question: 'Arrange to form: "I am afraid of being late"',
    options: ['di', 'fare', 'Ho', 'tardi', 'paura', '.'],
    answer: 'Ho paura di fare tardi.',
    hint: 'Start with "Ho paura"',
  },
  {
    id: 'p757',
    type: 'sentence_order',
    question: 'Arrange to form: "The lesson starts at nine"',
    options: ['comincia', 'la', 'lezione', 'alle', 'nove', '.'],
    answer: 'La lezione comincia alle nove.',
    hint: 'Start with "La lezione"',
  },
  {
    id: 'p758',
    type: 'fill_blank',
    question: 'Complete: "Finiscono le vacanze ___. (tomorrow)"',
    answer: 'domani',
    hint: 'The Italian word for "tomorrow"',
  },
  {
    id: 'p759',
    type: 'fill_blank',
    question: 'Complete: "___ sprecato troppo tempo. (I have wasted -1st person)"',
    answer: 'Ho',
    hint: 'verb "avere" + past participle',
  },
  {
    id: 'p760',
    type: 'fill_blank',
    question: 'Complete: "Piove, prendo l\'___. (umbrella)"',
    answer: 'ombrello',
  ...
  },
  {
    id: 'p761',
    type: 'fill_blank',
    question: 'Complete: "La mia ___ mi aiuta con il progetto. (colleague - feminine)"',
    answer: 'collega',
    hint: 'same word as masculine but feminine article',
  },
  {
    id: 'p762',
    type: 'fill_blank',
    question: 'Complete: "Lo ___ atleta ha vinto la gara. (fast - masculine)"',
    answer: 'veloce',
    hint: 'irregular adjective ending in -e',
  },
  {
    id: 'p763',
    type: 'listening',
    question: 'Listen: "Il veterinario"',
    options: ['The vet', 'The doctor', 'The nurse', 'The dentist'],
    answer: 'The vet',
    hint: 'treats animals',
  },
  {
    id: 'p764',
    type: 'listening',
    question: 'Listen: "La pasticceria"',
    options: ['The pastry shop', 'The bakery', 'The restaurant', 'The café'],
    answer: 'The pastry shop',
    hint: 'where cakes are sold',
  },
  {
    id: 'p765',
    type: 'listening',
    question: 'Listen: "La valigia"',
    options: ['Suitcase', 'Backpack', 'Handbag', 'Wallet'],
    answer: 'Suitcase',
    hint: 'a large piece of luggage',
  },
  {
    id: 'p766',
    type: 'listening',
    question: 'Listen: "Il mare"',
    options: ['The sea', 'The river', 'The lake', 'The beach'],
    answer: 'The sea',
