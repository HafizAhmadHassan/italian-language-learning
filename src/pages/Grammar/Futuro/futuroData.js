...
export const futuroExercises = [
  ...
  },
  {
    ...
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Beginner Story — Tra un anno',
    storyTitle: 'Tra un anno',
    story: 'Tra un anno la mia vita sarà molto diversa. Finirò l\'università e comincerò a lavorare in un\'agenzia di marketing.\n\nPrima di iniziare, farò un viaggio in Europa per tre settimane. Visiterò Parigi, Berlino e forse Lisbona. Poi tornerò a casa, affitterò un piccolo appartamento e comprerò una macchina usata.\n\nPasserò le serate con gli amici e nel tempo libero imparerò a suonare il pianoforte. Non sarà facile, ma ce la farò!',
    vocab: [
      { word: 'tra un anno', meaning: 'in a year' },
      { word: 'un\'agenzia di marketing', meaning: 'a marketing agency' },
      { word: 'affitterò', meaning: 'I will rent (affittare)' },
      { word: 'usata', meaning: 'used (second-hand)' },
      { word: 'il tempo libero', meaning: 'the free time' },
      { word: 'ce la farò', meaning: 'I will make it' },
    ],
    translation: 'In a year my life will be very different. I will finish university and start working in a marketing agency.\n\nBefore starting, I will take a trip around Europe for three weeks. I will visit Paris, Berlin and maybe Lisbon. Then I will come home, rent a small flat and buy a used car.\n\nI will spend the evenings with friends and in my free time I will learn to play the piano. It will not be easy, but I will make it!',
    questions: [
      { question: 'What will the narrator do before starting work?', options: ['Travel around Europe for three weeks', 'Buy a new house', 'Rest for a month'], answer: 'Travel around Europe for three weeks', explanation: '"farò un viaggio in Europa per tre settimane."' },
      { question: 'Which cities will he visit?', options: ['Paris, Berlin and maybe Lisbon', 'Rome, Madrid and London', 'Only Paris'], answer: 'Paris, Berlin and maybe Lisbon', explanation: '"Visiterò Parigi, Berlino e forse Lisbona."' },
      { question: 'What will he do after the trip?', options: ['Rent a flat and buy a used car', 'Move to another country', 'Open a shop'], answer: 'Rent a flat and buy a used car', explanation: '"affitterò un piccolo appartamento e comprerò una macchina usata."' },
      { question: 'What will he learn in his free time?', options: ['To play the piano', 'To cook', 'To ski'], answer: 'To play the piano', explanation: '"imparerò a suonare il pianoforte."' },
      { question: 'Which expressions point to a FUTURE time?', options: ['tra un anno', 'ieri sera', 'l\'anno scorso'], answer: 'tra un anno', explanation: '"tra un anno" = in a year (future). Ieri sera and l\'anno scorso are past expressions.' },
      { question: 'Write one sentence about what your life will be like in a year.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Tra un anno lavorerò in una grande città. Any correct future is accepted.' },
    ],
  },
  {
    id: 37,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Beginner Story — I progetti per l\'estate',
    storyTitle: 'I progetti per l\'estate',
    story: 'L\'estate prossima non andremo in vacanza al mare. Abbiamo deciso: faremo un giro in camper attraverso l\'Italia.\n\nPartiremo da Milano, attraverseremo le Alpi e scenderemo fino alla Sicilia. In ogni regione mangeremo i piatti tipici e incontreremo nuove persone. La mia compagna fotografa tutto; lei porterà la macchina fotografica e sarà la nostra "cronista ufficiale".\n\nSiamo sicuri che sarà un\'avventura indimenticabile. Non vediamo l\'ora!',
    vocab: [
      { word: 'un giro in camper', meaning: 'a round trip by camper van' },
      { word: 'attraverseremo', meaning: 'we will cross (attraversare)' },
      { word: 'i piatti tipici', meaning: 'the typical dishes' },
      { word: 'la macchina fotografica', meaning: 'the camera' },
      { word: 'la cronista ufficiale', meaning: 'the official reporter' },
      { word: 'non vediamo l\'ora', meaning: 'we can\'t wait' },
    ],
    translation: 'Next summer we will not go on holiday to the sea. We have decided: we will do a round trip by camper through Italy.\n\nWe will leave from Milan, cross the Alps and go all the way down to Sicily. In every region we will eat the typical dishes and meet new people. My partner photographs everything; she will bring the camera and will be our "official reporter".\n\nWe are sure it will be an unforgettable adventure. We can\'t wait!',
    questions: [
      { question: 'What will they do next summer?', options: ['A camper trip through Italy', 'Go to the sea', 'Stay home'], answer: 'A camper trip through Italy', explanation: '"faremo un giro in camper attraverso l\'Italia."' },
      { question: 'Where will the trip start?', options: ['From Milan', 'From Rome', 'From Sicily'], answer: 'From Milan', explanation: '"Partiremo da Milano."' },
      { question: 'What will they do in every region?', options: ['Eat typical dishes and meet new people', 'Visit museums only', 'Swim in the sea'], answer: 'Eat typical dishes and meet new people', explanation: '"mangeremo i piatti tipici e incontreremo nuove persone."' },
      { question: 'What will the narrator\'s partner be?', options: ['The official reporter with a camera', 'The driver', 'The cook'], answer: 'The official reporter with a camera', explanation: '"lei ... sarà la nostra cronista ufficiale."' },
      { question: 'Which verb ends are used for "partiremo, attraverseremo, mangeremo"?', options: ['Future -emo (noi)', 'Present -iamo (noi)', 'Past -avamo (noi)'], answer: 'Future -emo (noi)', explanation: 'These are all noi future forms: partiremo, attraverseremo, mangeremo.' },
      { question: 'Write one sentence about your plans for next summer using the future tense.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: D\'estate andrò in Grecia con gli amici. Any correct future is accepted.' },
    ],
  },
  {
    id: 38,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Intermediate Story — Un futuro senza macchine',
    storyTitle: 'Un futuro senza macchine',
    story: 'Immaginiamo come sarà la città del futuro. Probabilmente non ci saranno più le auto private nel centro. La gente userà i mezzi pubblici elettrici o andrà in bicicletta.\n\nLe strade saranno piene di alberi e le piazze saranno grandi spazi verdi. Gli edifici produrranno energia dal sole. Grazie a queste scelte, l\'aria sarà più pulita e la vita sarà più sana.\n\nCerto, tutto questo non accadrà domani. Ma se tutti faremo la nostra parte, il nostro quartiere migliorerà già fra pochi anni.',
    vocab: [
      { word: 'i mezzi pubblici', meaning: 'the public transport' },
      { word: 'elettrici', meaning: 'electric' },
      { word: 'gli spazi verdi', meaning: 'the green spaces' },
      { word: 'produrranno', meaning: 'they will produce (produrre)' },
      { word: 'accadrà', meaning: 'it will happen (accadere)' },
      { word: 'migliorerà', meaning: 'it will improve (migliorare)' },
    ],
    translation: 'Let us imagine what the city of the future will be like. Probably there will no longer be private cars in the centre. People will use electric public transport or go by bicycle.\n\nThe streets will be full of trees and the squares will be big green spaces. The buildings will produce energy from the sun. Thanks to these choices, the air will be cleaner and life will be healthier.\n\nOf course, all this will not happen tomorrow. But if we all do our part, our neighbourhood will improve already in a few years.',
    questions: [
      { question: 'What will probably disappear from the centre of the future city?', options: ['Private cars', 'Buses', 'Bicycles'], answer: 'Private cars', explanation: '"non ci saranno più le auto private nel centro."' },
      { question: 'How will people move around?', options: ['By electric public transport or bike', 'By private planes', 'On foot only'], answer: 'By electric public transport or bike', explanation: '"userà i mezzi pubblici elettrici o andrà in bicicletta."' },
      { question: 'What will the buildings produce?', options: ['Energy from the sun', 'Water', 'Food'], answer: 'Energy from the sun', explanation: '"Gli edifici produrranno energia dal sole."' },
      { question: 'What will be the benefits?', options: ['Cleaner air and healthier life', 'More traffic', 'Higher prices'], answer: 'Cleaner air and healthier life', explanation: '"l\'aria sarà più pulita e la vita sarà più sana."' },
      { question: '"produrranno" — this future form comes from which verb?', options: ['produrre (irregular future)', 'produrre (regular)', 'portare'], answer: 'produrre (irregular future)', explanation: 'produrre has an irregular future: produrrò, produrrai, produrranno.' },
      { question: 'Write one sentence about how you imagine the future city, using the future tense.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Nella città del futuro ci saranno molti parchi. Any correct future is accepted.' },
    ],
  },
  {
    id: 39,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Intermediate Story — La casa del futuro',
    storyTitle: 'La casa del futuro',
    story: 'Fra trent\'anni le case saranno completamente diverse. Saranno intelligenti: le luci si accenderanno da sole e la temperatura si regolerà da sé.\n\nI robot faranno le pulizie e forse anche la spesa! Le finestre cambieranno colore secondo la luce. Le famiglie guarderanno i film su parete intera senza schermo.\n\nNaturalmente, tutto costerà caro all\'inizio. Ma con il tempo, questi strumenti diventeranno normali, esattamente come oggi lo sono il frigorifero o la lavatrice.',
    vocab: [
      { word: 'intelligenti', meaning: 'smart' },
      { word: 'si accenderanno', meaning: 'they will switch on (themselves)' },
      { word: 'si regolerà', meaning: 'it will regulate itself' },
      { word: 'le pulizie', meaning: 'the cleaning' },
      { word: 'la lavatrice', meaning: 'the washing machine' },
      { word: 'il frigorifero', meaning: 'the fridge' },
    ],
    translation: 'In thirty years the houses will be completely different. They will be smart: the lights will switch on by themselves and the temperature will regulate itself.\n\nThe robots will do the cleaning and maybe even the shopping! The windows will change colour according to the light. Families will watch films on a whole wall without a screen.\n\nNaturally, everything will be expensive at the beginning. But with time, these devices will become normal, exactly as today the fridge or the washing machine are.',
    questions: [
      { question: 'In how many years will houses be different?', options: ['In thirty years', 'In three years', 'In ten years'], answer: 'In thirty years', explanation: '"Fra trent\'anni le case saranno completamente diverse."' },
      { question: 'What will the lights do?', options: ['Switch on by themselves', 'Stay off', 'Change to green'], answer: 'Switch on by themselves', explanation: '"le luci si accenderanno da sole."' },
      { question: 'What will robots do?', options: ['Clean and maybe shop', 'Cook only', 'Drive the car'], answer: 'Clean and maybe shop', explanation: '"I robot faranno le pulizie e forse anche la spesa!"' },
      { question: 'How will families watch films?', options: ['On a whole wall without a screen', 'On a small television', 'In the cinema only'], answer: 'On a whole wall without a screen', explanation: '"guarderanno i film su parete intera senza schermo."' },
      { question: 'What did the narrator compare these future devices to?', options: ['The fridge and the washing machine today', 'The telephone', 'The book'], answer: 'The fridge and the washing machine today', explanation: '"esattamente come oggi lo sono il frigorifero o la lavatrice."' },
      { question: 'Write one sentence about a device of the future using the future tense.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: In futuro i robot cucineranno per noi. Any correct future is accepted.' },
    ],
  },
  {
    id: 40,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Beginner Story — Domani all\'università',
    storyTitle: 'Domani all\'università',
    story: 'Domani avrò un giorno pieno all\'università. La prima lezione comincerà alle nove: sarà la storia dell\'arte. La mia professoressa è molto severa, quindi arriverò con dieci minuti di anticipo.\n\nDopo la lezione incontrerò Paolo in biblioteca. Studieremo insieme fino alle due e poi mangeremo un panino al bar.\n\nAlle tre ci sarà il seminario di italiano per stranieri. Io e Paolo faremo una presentazione. Non saremo perfetti, ma faremo del nostro meglio.',
    vocab: [
      { word: 'la storia dell\'arte', meaning: 'the history of art' },
      { word: 'severa', meaning: 'strict (feminine)' },
      { word: 'con anticipo', meaning: 'early / ahead' },
      { word: 'la biblioteca', meaning: 'the library' },
      { word: 'il seminario', meaning: 'the seminar' },
      { word: 'faremo del nostro meglio', meaning: 'we will do our best' },
    ],
    translation: 'Tomorrow I will have a full day at university. The first lesson will start at nine: it will be history of art. My professor is very strict, so I will arrive ten minutes early.\n\nAfter the lesson I will meet Paolo in the library. We will study together until two and then eat a sandwich at the bar.\n\nAt three there will be the seminar of Italian for foreigners. Paolo and I will give a presentation. We will not be perfect, but we will do our best.',
    questions: [
      { question: 'What will the first lesson be?', options: ['History of art', 'Mathematics', 'Chemistry'], answer: 'History of art', explanation: '"sarà la storia dell\'arte."' },
      { question: 'Why will the narrator arrive early?', options: ['Because the professor is very strict', 'Because he likes waiting', 'Because the bus is early'], answer: 'Because the professor is very strict', explanation: '"La mia professoressa è molto severa, quindi arriverò con dieci minuti di anticipo."' },
      { question: 'Where will the narrator meet Paolo?', options: ['In the library', 'At the bar', 'In the classroom'], answer: 'In the library', explanation: '"incontrerò Paolo in biblioteca."' },
      { question: 'How long will they study together?', options: ['Until two', 'Until nine', 'All day'], answer: 'Until two', explanation: '"Studieremo insieme fino alle due."' },
      { question: 'What will they do at the seminar?', options: ['Give a presentation', 'Take an exam', 'Listen only'], answer: 'Give a presentation', explanation: '"Io e Paolo faremo una presentazione."' },
      { question: 'Write one sentence about your plan for tomorrow using the future tense.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Domani studierò in biblioteca. Any correct future is accepted.' },
    ],
  },
  {
    id: 41,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Intermediate Story — Il viaggio spaziale',
    storyTitle: 'Il viaggio spaziale',
    story: 'Fra cento anni, forse, i viaggi spaziali saranno comuni come oggi i viaggi in aereo. Le agenzie venderanno biglietti per la luna e per Marte.\n\nI turisti dello spazio osserveranno la terra da lontano e faranno passeggiate a gravità zero. Negli alberghi spaziali ci saranno finestre enormi per vedere le stelle. Dormiremo "guardando" l\'universo!\n\nEcco perché penso che io studierò l\'ingegneria aerospaziale: nella mia città costruiranno la prima stazione spaziale privata. Io sarò lì.',
    vocab: [
      { word: 'i viaggi spaziali', meaning: 'the space travels' },
      { word: 'le agenzie', meaning: 'the agencies' },
      { word: 'a gravità zero', meaning: 'in zero gravity' },
      { word: 'gli alberghi spaziali', meaning: 'the space hotels' },
      { word: 'la stazione spaziale', meaning: 'the space station' },
      { word: 'l\'ingegneria aerospaziale', meaning: 'aerospace engineering' },
    ],
    translation: 'In a hundred years, perhaps, space travels will be as common as plane trips today. The agencies will sell tickets for the moon and for Mars.\n\nThe space tourists will observe the earth from far away and take walks in zero gravity. In the space hotels there will be enormous windows to see the stars. We will sleep "looking" at the universe!\n\nThat is why I think I will study aerospace engineering: in my city they will build the first private space station. I will be there.',
    questions: [
      { question: 'When will space travel perhaps be common?', options: ['In a hundred years', 'Next year', 'In ten years'], answer: 'In a hundred years', explanation: '"Fra cento anni, forse, i viaggi spaziali saranno comuni."' },
      { question: 'What will the agencies sell?', options: ['Tickets for the moon and Mars', 'Tickets for the cinema', 'Souvenirs'], answer: 'Tickets for the moon and Mars', explanation: '"Le agenzie venderanno biglietti per la luna e per Marte."' },
      { question: 'What will space tourists do?', options: ['Observe the earth and walk in zero gravity', 'Open restaurants', 'Drive rockets'], answer: 'Observe the earth and walk in zero gravity', explanation: '"osserverranno la terra da lontano e faranno passeggiate a gravità zero."' },
      { question: 'Why will the narrator study aerospace engineering?', options: ['Because they will build the first private space station in his city', 'Because it is easy', 'Because his father did it'], answer: 'Because they will build the first private space station in his city', explanation: '"nella mia città costruiranno la prima stazione spaziale privata."' },
      { question: 'Match the pronouns with the verbs: "io ___", "loro ___".', options: ['studierò / costruiranno', 'studieremo / costruirò', 'studieranno / costruiremo'], answer: 'studierò / costruiranno', explanation: 'io studierò (I), loro costruiranno (they).' },
      { question: 'Write one sentence imagining a futuristic trip or technology.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Fra cento anni vivremo anche su Marte. Any correct future is accepted.' },
    ],
  },
  {
    id: 42,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Intermediate Story — Finalmente laureato!',
    storyTitle: 'Finalmente laureato!',
    story: 'Il mese prossimo finalmente mi laureerò! Dopo cinque anni di studio, discuterò la mia tesi sul turismo sostenibile.\n\nAl termine della discussione il mio relatore dirà le ultime parole e poi, se tutto andrà bene, riceverò il titolo di dottore.\n\nDopo la cerimonia festeggeremo con la famiglia e gli amici. Non vedo l\'ora di vedere la faccia dei miei genitori: saranno così orgogliosi! Poi cercherò un lavoro e ... chissà, un giorno aprirò la mia agenzia di viaggi.',
    vocab: [
      { word: 'mi laureerò', meaning: 'I will graduate (laurearsi)' },
      { word: 'la tesi', meaning: 'the thesis' },
      { word: 'il turismo sostenibile', meaning: 'sustainable tourism' },
      { word: 'il relatore', meaning: 'the thesis supervisor' },
      { word: 'orgogliosi', meaning: 'proud' },
      { word: 'un\'agenzia di viaggi', meaning: 'a travel agency' },
    ],
    translation: 'Next month I will finally graduate! After five years of study, I will discuss my thesis on sustainable tourism.\n\nAt the end of the discussion my supervisor will say the last words and then, if everything goes well, I will receive the title of doctor.\n\nAfter the ceremony we will celebrate with family and friends. I can\'t wait to see the face of my parents: they will be so proud! Then I will look for a job and... who knows, one day I will open my travel agency.',
    questions: [
      { question: 'When will the narrator graduate?', options: ['Next month', 'Next year', 'In five years'], answer: 'Next month', explanation: '"Il mese prossimo finalmente mi laureerò!"' },
      { question: 'What is the thesis about?', options: ['Sustainable tourism', 'Ancient history', 'Economy'], answer: 'Sustainable tourism', explanation: '"discuterò la mia tesi sul turismo sostenibile."' },
      { question: 'How will the parents react?', options: ['They will be proud', 'They will cry tears of joy', 'They will be indifferent'], answer: 'They will be proud', explanation: '"saranno così orgogliosi!"' },
      { question: 'What might the narrator open one day?', options: ['A travel agency', 'A restaurant', 'A gym'], answer: 'A travel agency', explanation: '"un giorno aprirò la mia agenzia di viaggi."' },
      { question: 'What is the irregular future form of "io dirò"?', options: ['dirò (from dire)', 'dicerò', 'diro'], answer: 'dirò (from dire)', explanation: 'dire is irregular in the future: dirò, dirai, dirà.' },
      { question: 'Write one sentence about a goal you will achieve, using the future tense.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Un giorno scriverò un libro. Any correct future is accepted.' },
    ],
  },
  {
    id: 43,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Beginner Story — Un nuovo hobby',
    storyTitle: 'Un nuovo hobby',
    story: 'Quest\'inverno comincerò un nuovo hobby: il corso di ceramica. Ogni giovedì sera andrò in un laboratorio vicino a casa mia.\n\nImparerò a modellare l\'argilla e a decorare i vasi. Il maestro dice che all\'inizio non sarà facile, ma con la pratica migliorerò.\n\nAlla fine del corso farò un regalo speciale: una tazza fatta con le mie mani per mia madre. Sono sicuro che le piacerà. E chissà, magari diventerà un vero mestiere!',
    vocab: [
      { word: 'la ceramica', meaning: 'the ceramics / pottery' },
      { word: 'il laboratorio', meaning: 'the workshop' },
      { word: 'l\'argilla', meaning: 'the clay' },
      { word: 'i vasi', meaning: 'the vases' },
      { word: 'una tazza', meaning: 'a cup' },
      { word: 'un mestiere', meaning: 'a craft / profession' },
    ],
    translation: 'This winter I will start a new hobby: the pottery course. Every Thursday evening I will go to a workshop near my home.\n\nI will learn to shape the clay and to decorate the vases. The teacher says that in the beginning it will not be easy, but with practice I will improve.\n\nAt the end of the course I will make a special gift: a cup made with my own hands for my mother. I am sure she will like it. And who knows, maybe it will become a real craft!',
    questions: [
      { question: 'When will the narrator start the pottery course?', options: ['This winter', 'Next summer', 'Last month'], answer: 'This winter', explanation: '"Quest\'inverno comincerò un nuovo hobby."' },
      { question: 'When will he go to the workshop?', options: ['Every Thursday evening', 'Every morning', 'On Sundays'], answer: 'Every Thursday evening', explanation: '"Ogni giovedì sera andrò in un laboratorio."' },
      { question: 'What will he learn?', options: ['To shape clay and decorate vases', 'To paint portraits', 'To weld metal'], answer: 'To shape clay and decorate vases', explanation: '"Imparerò a modellare l\'argilla e a decorare i vasi."' },
      { question: 'What gift will he make at the end?', options: ['A cup for his mother', 'A vase for his teacher', 'A plate for himself'], answer: 'A cup for his mother', explanation: '"una tazza fatta con le mie mani per mia madre."' },
      { question: '"con la pratica migliorerò" — migliorerò is the future of...?', options: ['migliorare', 'megliorare', 'mangiare'], answer: 'migliorare', explanation: 'migliorare (to improve): io migliorerò.' },
      { question: 'Write one sentence about a hobby you will start or will try.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Presto imparerò a cucinare la pizza. Any correct future is accepted.' },
    ],
  },
  {
    id: 44,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Beginner Story — Cosa farò quando sarò grande',
    storyTitle: 'Cosa farò quando sarò grande',
    story: 'Quando sarò grande vorrò fare tante cose! Per prima cosa andrò in Africa a vedere i safari. Poi diventerò un veterinario per aiutare gli animali.\n\nCon i soldi che guadagnerò comprerò una casa vicino al mare. La mattina aprirò le finestre e sentirò il profumo dell\'acqua. La sera porterò i miei amici a cena e vedranno insieme il tramonto.\n\nCerto, questo lo so, non sarà tutto facile. Ma io non perderò mai la speranza.',
    vocab: [
      { word: 'il safari', meaning: 'the safari' },
      { word: 'un veterinario', meaning: 'a vet' },
      { word: 'guadagnerò', meaning: 'I will earn (guadagnare)' },
      { word: 'il profumo', meaning: 'the smell' },
      { word: 'il tramonto', meaning: 'the sunset' },
      { word: 'non perderò mai la speranza', meaning: 'I will never lose hope' },
    ],
    translation: 'When I grow up I will want to do many things! First of all I will go to Africa to see the safaris. Then I will become a vet to help the animals.\n\nWith the money I will earn, I will buy a house near the sea. In the morning I will open the windows and smell the water. In the evening I will take my friends to dinner and we will watch the sunset together.\n\nOf course, I know this: it will not all be easy. But I will never lose hope.',
    questions: [
      { question: 'Where will the narrator go first?', options: ['To Africa to see safaris', 'To the moon', 'To Paris'], answer: 'To Africa to see safaris', explanation: '"andro in Africa a vedere i safari."' },
      { question: 'What will he become?', options: ['A vet', 'A pilot', 'A teacher'], answer: 'A vet', explanation: '"diventerò un veterinario."' },
      { question: 'What will he buy with the money he earns?', options: ['A house near the sea', 'A fast car', 'A boat'], answer: 'A house near the sea', explanation: '"comprerò una casa vicino al mare."' },
      { question: 'What will he do in the evening?', options: ['Take friends to dinner and watch the sunset', 'Work late', 'Go jogging'], answer: 'Take friends to dinner and watch the sunset', explanation: '"porterò i miei amici a cena e vedranno il tramonto" — he will take his friends to dinner and they will watch the sunset.' },
      { question: 'What value does the narrator promise?', options: ['He will never lose hope', 'He will never work', 'He will never travel'], answer: 'He will never lose hope', explanation: '"io non perderò mai la speranza."' },
      { question: 'Write one sentence about what you will do when you are older.', type: 'text', answer: 'any', acceptedAnswers: [], explanation: 'Example: Quando sarò grande viaggerò per il mondo. Any correct future is accepted.' },
    ],
  },
  {
    id: 45,
    type: 'story',
    level: 'Level 7 — Stories',
    title: 'Read and Answer in Italian — Il piano di domani',
    storyTitle: 'Il piano di domani',
    story: 'Domani sarà una giornata intensa per Sara. La mattina andrà in palestra alle sette. Dopo la doccia incontrerà il suo capo per discutere del nuovo progetto.\n\nA mezzogiorno pranzerà con la sua migliore amica al ristorante giapponese. Nel pomeriggio porterà i documenti al tribunale e poi farà la spesa.\n\nLa sera preparerà la cena per la sua famiglia e guarderà un film sul divano. Se il tempo lo permetterà, prima di dormire farà una passeggiata nel parco.',
    vocab: [
      { word: 'intensa', meaning: 'intense / busy' },
      { word: 'discutere', meaning: 'to discuss' },
      { word: 'il progetto', meaning: 'the project' },
      { word: 'il tribunale', meaning: 'the court' },
      { word: 'una passeggiata', meaning: 'a walk' },
      { word: 'il tempo lo permetterà', meaning: 'the weather will allow it' },
    ],
    translation: 'Tomorrow will be an intense day for Sara. In the morning she will go to the gym at seven. After the shower she will meet her boss to discuss the new project.\n\nAt noon she will have lunch with her best friend at the Japanese restaurant. In the afternoon she will take the documents to the court and then do the shopping.\n\nIn the evening she will prepare dinner for her family and watch a film on the sofa. If the weather allows it, before sleeping she will take a walk in the park.',
    questions: [
      { question: 'Dove andrà Sara la mattina? (Where will Sara go in the morning?)', type: 'text', acceptedAnswers: ['in palestra', 'in palestra alle sette', 'andrà in palestra', 'andrà in palestra alle sette'], answer: 'Andrà in palestra.', explanation: 'The story says: "La mattina andrà in palestra alle sette."' },
      { question: 'Chi incontrerà dopo la doccia? (Who will she meet after the shower?)', type: 'text', acceptedAnswers: ['il suo capo', 'il capo', 'incontrerà il suo capo', 'il direttore'], answer: 'Incontrerà il suo capo.', explanation: 'The story says: "incontrerà il suo capo per discutere del nuovo progetto."' },
      { question: 'Dove pranzerà? (Where will she have lunch?)', type: 'text', acceptedAnswers: ['al ristorante giapponese', 'in un ristorante giapponese', 'con la sua amica al ristorante giapponese', 'al giapponese'], answer: 'Pranzerà al ristorante giapponese.', explanation: 'The story says: "pranzerà con la sua migliore amica al ristorante giapponese."' },
      { question: 'Cosa porterà al tribunale? (What will she take to the court?)', type: 'text', acceptedAnswers: ['i documenti', 'porterà i documenti', 'i documenti del progetto', 'i documenti e la spesa'], answer: 'Porterà i documenti.', explanation: 'The story says: "porterà i documenti al tribunale."' },
      { question: 'Cosa farà prima di dormire? (What will she do before sleeping?)', type: 'text', acceptedAnswers: ['una passeggiata', 'farà una passeggiata nel parco', 'una passeggiata nel parco', 'se il tempo lo permetterà farà una passeggiata'], answer: 'Farà una passeggiata nel parco.', explanation: 'The story says: "farà una passeggiata nel parco."' },
      { question: 'Trova tre verbi al futuro nella storia. (Find three future-tense verbs in the story.)', type: 'text', acceptedAnswers: [], answer: 'Any three, e.g. sarà, andrà, incontrerà, pranzerà, porterà, farà, preparerà, guarderà, permetterà.', explanation: 'Examples: sarà, andrà, incontrerà, pranzerà, porterà, farà, preparerà, guarderà.' },
    ],
  },
